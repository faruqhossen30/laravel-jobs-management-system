                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="twitter" id="twitter"
                                            placeholder="twitter" aria-label="twitter" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="youtube" id="youtube"
                                            placeholder="youtube" aria-label="youtube" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="linkedin" id="linkedin"
                                            placeholder="linkedin" aria-label="linkedin" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ceo_name" id="ceo_name"
                                            placeholder="ceo_name" aria-label="ceo_name" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1">Ownership Type</span>
                                        <input type="number" class="form-control" name="ownership_type"
                                            id="ownership_type" placeholder="ownership_type" aria-label="ownership_type"
                                            aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="division_id" id="division_id"
                                            placeholder="division_id" aria-label="division_id"
                                            aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="district_id" id="district_id"
                                            placeholder="district_id" aria-label="district_id"
                                            aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control" name="establish" id="establish"
                                            placeholder="establish" aria-label="establish"
                                            aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="total_office" id="total_office"
                                            placeholder="total_office" aria-label="total_office"
                                            aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control" name="employ_range" id="employ_range"
                                            placeholder="employ_range" aria-label="employ_range"
                                            aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea class="form-control" name="google_map" id="google_map" rows="10"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
