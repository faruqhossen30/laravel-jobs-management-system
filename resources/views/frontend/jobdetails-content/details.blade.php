            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card job-detail overflow-hidden">
                        <div>
                            <img src="{{asset('frontend')}}/assets/images/job-detail.jpg" alt="" class="img-fluid">
                            <div class="job-details-compnay-profile">
                                <img src="{{asset('frontend')}}/assets/images/featured-job/img-10.png" alt="" class="img-fluid rounded-3 rounded-3">
                            </div>
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="job-box card mt-4">
                            <div class="p-4">
                                <div class="row">
                                    <div class="col-lg-1">
                                        <img src="{{asset('frontend')}}/assets/images/featured-job/img-03.png" alt="" class="img-fluid rounded-3">
                                    </div><!--end col-->
                                    <div class="col-lg-10">
                                        <div class="mt-3 mt-lg-0">
