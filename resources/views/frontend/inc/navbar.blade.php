                 ...
                 <ul class="navbar-nav mx-auto navbar-center">
                     ...
                     <li class="nav-item dropdown dropdown-hover">
                         ...
                         <ul class="dropdown-menu dropdown-menu-center" aria-labelledby="productdropdown">
                             ...
                             <li><a class="dropdown-item" href="{{ route('jobdetails') }}">JOb Details</a></li>
                             <li><a class="dropdown-item" href="{{ route('jobindustry') }}">Job Industry</a></li>


                             <li><a class="dropdown-item" href="{{ route('contact') }}">Contact </a></li>
                             <li><a class="dropdown-item" href="{{ route('company.details') }}">Company Details</a>
                             </li>
                             <li><a class="dropdown-item" href="{{ route('about') }}">About Us </a></li>
                             <li><a class="dropdown-item" href="{{ route('service') }}">Service</a></li>
                             <li><a class="dropdown-item" href="{{ route('policy') }}">Priacy & Policy</a></li>
